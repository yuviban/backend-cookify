...
app =Flask (__name__)
CORS(app)
df_recipes = pd.read_csv('input/df_parsed.csv')
...
def get_recommendations(N, scores):
    ...
    recommendation = pd.DataFrame(columns=["recipe", "ingredients", "score", "url",'n_steps','n_ingredients','nutrition'])
    count = 0
    for i in top:
...
@app.route('/')  
def home():
    return "Welcome to our cookify api"
